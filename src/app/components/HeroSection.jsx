...
export default function HeroSection() {
  return (
    <section className="relative bg-gradient-to-b from-blue-400 to-blue-600 py-20 min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 lg:px-16 grid lg:grid-cols-1 items-center gap-12 relative z-10">
        {/* Left Content */}
        <motion.div
      ...
      <motion.div
        ...
        className="container mx-auto px-6 lg:px-16 mt-16 z-10"
      >
