...
export default function PopupForm({
  ...
  // ... your handleChange and handleSubmit functions stay the same ...
  ...
  const modalContent = (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <motion.div
            className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6 md:p-8 overflow-y-auto max-h-[90vh]"
            initial={{ scale: 0.8, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            exit={{ scale: 0.8, opacity: 0 }}
          >
            <button
              className="absolute bg-white rounded-full border border-gray-200 p-1 shadow-lg top-4 right-4 text-gray-500 hover:text-[#ff6900]"
  ...
  //         >
  //           <motion.div
  //             className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6 md:p-8 overflow-y-auto max-h-[90vh] !z-[9999] top-15"
  //             initial={{ scale: 0.8, opacity: 0 }}
  //             animate={{ scale: 1, opacity: 1 }}
  //             exit={{ scale: 0.8, opacity: 0 }}
  //           >
