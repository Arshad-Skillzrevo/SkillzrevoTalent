...
const Page = () => {
  ...
  return (
    <div className="bg-white text-gray-800 overflow-hidden">
      ...
      >
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1556742502-ec7c0e9f34b1?q=80&w=1600')] bg-cover bg-center opacity-10"></div>
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          ...
          >
            Contract Staffing Services to Keep Your Business Agile
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <AnimatedSection className="py-20 px-4 max-w-6xl mx-auto bg-white">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700 leading-relaxed max-w-4xl mx-auto">
            In today’s dynamic business environment, workforce needs are evolving faster than ever. At SkillzRevo Talent, we empower organizations with flexible <span className="font-semibold text-[#ff6900]">Contract Staffing</span> solutions designed to handle short-term projects, seasonal spikes, and specialized skill demands — without the overheads of permanent hiring.
          </p>
      ...
      {/* Section 2 – What is Contract Staffing? (Updated Content) */}
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-700 mb-4">
              Contract Staffing involves hiring professionals on a <span className="font-semibold">temporary or project basis</span> while keeping them on our payroll. This removes the administrative burden of salary processing, compliance, and benefits, allowing your company to focus entirely on core business outcomes.
            </p>
            <ul className="space-y-3 text-lg text-gray-700">
                <li className="flex items-start gap-2"><FaCheckCircle className="text-2xl text-[#1d8fff] flex-shrink-0 mt-1" /> Ideal for <span className="font-semibold">short-term projects</span></li>
                <li className="flex items-start gap-2"><FaCheckCircle className="text-2xl text-[#1d8fff] flex-shrink-0 mt-1" /> Suitable for <span className="font-semibold">seasonal workforce demands</span></li>
                <li className="flex items-start gap-2"><FaCheckCircle className="text-2xl text-[#1d8fff] flex-shrink-0 mt-1" /> Perfect for <span className="font-semibold">specialized roles and niche skills</span></li>
            </ul>
          </div>
          <div className="flex justify-center">
            <img
              src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&w=600" // Updated Image
