...
const RPO = () => {
  ...
  // Stats for Code 1 style but with RPO-relevant content and arbitrary numbers
  const rpoKeyBenefits = [
    {
      icon: TrendingUp,
      label: "70% Reduction in Time-to-Hire",
      color: "#1d8fff",
    },
    { icon: Clock, label: "95% Retention Rate", color: "#1d8fff" },
    {
      icon: CheckCircle2,
      label: "100% Compliance & Onboarding",
      color: "#ff6900",
    },
  ];
...
<div className="relative bg-white overflow-hidden py-8 md:py-16">
        ...
        <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center  mx-auto px-6 md:px-12 lg:px-16 py-16 lg:py-20">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                <span className="text-slate-900">Recruitment Process</span>
                <br />
            ...
            {/* Key Benefits (Code 1 Design + Custom RPO Stats) */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            {/* CTA Buttons (Code 1 Design + Code 2 Page URL/Service) */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="relative">
              ...
              <motion.div
                ...
                className="relative"
              >
                {/* Image Frame (Using RPO-relevant image from Code 2) */}
                ...
                {/* Floating Stat Cards (Code 1 Design + Custom RPO Stats) */}
                <motion.div
                  animate={{ y: [0, 10, 0] }}
                  transition={{
                    duration: 3,
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">Time-to-Hire Cut</p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">Talent Retention</p>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
      ...
      {/* ========== SECTION 2: INTRODUCTION (Code 1 Design + Code 2 Content) ========== */}
      <motion.section
        style={{ opacity: heroOpacity }}
        className="relative h-auto flex items-center text-white overflow-hidden py-24"
      >
        {/* Background Image/Overlay (Code 1 Feature) */}
        <div className="w-full h-full bg-[url('https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=1600')] bg-cover bg-center absolute z-0"></div>
        ...
        <AnimatedSection className="py-20 px-4 max-w-6xl mx-auto relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-200 mt-4 max-w-4xl mx-auto">
              {/* Code 2 Content */}
              Whether you’re expanding rapidly or seeking niche skills, our RPO services help you <span className="font-bold uppercase text-[#ff6900]">scale hiring efficiently while focusing on your core business objectives.</span>
            </p>
          </div>
        </AnimatedSection>
      </motion.section>

      {/* ========== SECTION 3: WHAT IS RPO? (Code 1 Design + Code 2 Content) ========== */}
      <div className="grid md:grid-cols-2 items-center justify-center h-full">
        <div className="bg-blue-50 p-16 flex items-center justify-center h-full order-1 md:order-1">
          <div className="text-center md:text-left ">
            ...
            >
              <SiGooglegemini /> Strategic RPO Partnership
            </motion.p>
            <motion.div
              initial={{ opacity: 0, x: -50 }}
              animate={{ opacity: 1, x: 0 }}
            ...
            >
              ...
              <p className="text-lg lg:text-xl text-gray-500 mb-4 max-w-xl md:max-w-none mx-auto md:mx-0">
                {/* Code 2 Content */}
                <span className="font-semibold text-gray-700">Recruitment Process Outsourcing (RPO)</span> is a strategic partnership where SkillzRevo Talent takes ownership of all or part of your recruitment lifecycle — from talent sourcing to onboarding.
              </p>
              <p className="text-lg lg:text-xl text-gray-500 mb-10 max-w-xl md:max-w-none mx-auto md:mx-0 border-l-4 border-[#ff6900] pl-4">
                {/* Modified Code 2 Content */}
                Acting as an <span className="font-semibold text-gray-700">extension of your HR team</span>, we bring industry expertise, advanced recruitment technology, and data-driven strategies to ensure scalable, high-quality hiring solutions across all levels.
              </p>
            </motion.div>
          </div>
        </div>
